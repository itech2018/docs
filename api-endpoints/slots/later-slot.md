...
{% swagger baseUrl="https://api.radiopanel.co" path="/api/v1/slots/later" method="get" summary="Get a later slot" %}
{% swagger-description %}
...
{% swagger-response status="204" description="Empty body if there is no later slot" %}
```
```
{% endswagger-response %}
{% endswagger %}
